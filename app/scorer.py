...
# Niche keyword sets  (home insurance / home services / refinance + adjacent)
NICHES = {
    "Home Insurance": {
        "home insurance", "homeowners insurance", "homeowner", "premium", "premiums",
        "policy", "coverage", "claim", "claims", "deductible", "insurer", "insurers",
        "flood insurance", "wildfire", "hurricane", "storm", "hail", "damage",
        "natural disaster", "catastrophe", "fire", "flood", "tornado",
    },
    "Refinance": {
        "refinance", "refi", "mortgage", "mortgages", "interest rate", "interest rates",
        "rate cut", "fed", "federal reserve", "home loan", "loan", "lending",
        "heloc", "equity", "apr", "30-year", "fixed rate", "housing market",
        "home prices", "borrowing", "lender", "lenders",
    },
    "Home Services": {
        "renovation", "remodel", "repair", "repairs", "contractor", "contractors",
        "plumbing", "roofing", "roof", "hvac", "solar", "energy bill", "utility",
        "utilities", "diy", "home improvement", "real estate", "property", "housing",
        "rent", "landlord", "moving", "maintenance",
    },
}
