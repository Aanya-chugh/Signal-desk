...
/* ---------- Facebook-style AD creative (Nano Banana Pro) ---------- */
// A rotating set of art directions so no two ads look like the same template.
const AD_STYLES = [
  "a bold full-bleed lifestyle photograph with the headline set large in a modern sans-serif across the upper third",
  "a clean minimalist studio composition with generous negative space and the headline in elegant type to one side",
  "a striking split layout: a vivid photo on one half, a solid bold color panel carrying the headline on the other",
  "a warm, authentic UGC / influencer-style candid phone photo with a casual, friendly headline caption",
  "a high-contrast, dramatically color-graded scene with a punchy oversized headline anchored at the bottom",
  "a bright, optimistic editorial magazine-style ad with refined serif typography and a confident headline",
  "an energetic promotional layout with a dynamic diagonal composition and a bold headline banner",
  "a cozy, trustworthy real-life moment, captured candidly, with a simple clean headline overlaid tastefully",
  "a sleek modern product-hero shot with cinematic lighting and the headline integrated into the scene",
];
function adPrompt(niche, headline, subline, story, style) {
  return [
    "Design a complete, original, scroll-stopping Facebook feed advertisement image, 1:1 square.",
    "It must look like a real, premium ad made by a top creative agency — NOT a generic template.",
    "Art direction for THIS specific ad: " + style + ".",
    "The product / offer being advertised: " + niche + ".",
    "Topical mood (informs the scene, do NOT print this as text): " + story + ".",
    'Render this exact headline prominently in the image, large and perfectly spelled: "' + headline + '".',
    subline ? 'You may add this shorter supporting line, smaller and secondary: "' + subline + '".' : "",
    "All typography must be crisp, correctly spelled, and beautifully integrated into the composition (not a plain caption bar).",
    "Use a modern premium color palette, strong focal subject, and high production value.",
    "Strictly NO brand names, NO logos, NO watermark, NO 'Signal Desk', and NO fake UI buttons or 'Get a Quote' badges.",
    "No recognizable real public figures. Give it a unique, original layout — avoid anything that looks like a fixed template.",
  ].filter(Boolean).join(" ");
}
